...
class AniListProvider {
  static String get anilistToken {
    return JiruHubStorage.getSetting(SettingKey.aniListToken);
  }

  static String get userid {
    return JiruHubStorage.getSetting(SettingKey.aniListUserId);
  }
  ...
  static Future<Map<String, dynamic>> getuserData() async {
    ...
    JiruHubStorage.setSetting(SettingKey.aniListUserId, userId);
