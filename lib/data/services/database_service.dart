...
class DatabaseService {
  static final db = JiruHubStorage.database;
  ...
  // 存储 JiruHubDetail
  static Future<Id> putJiruHubDetail(
    String package,
    String url,
  ...
  // 获取 JiruHubDetail
  static Future<JiruHubDetail?> getJiruHubDetail(
    String package,
    String url,
  ) async {
    return await db.jiruHubDetails
        .filter()
        .packageEqualTo(package)
        .and()
        .urlEqualTo(url)
