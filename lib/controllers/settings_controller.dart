...
class SettingsController extends GetxController {
  ...
  final links = {
    'Github': 'https://github.com/jephersonRD/JiruHub',
    'Youtube': 'https://www.youtube.com/@jephmd',
    'Website': 'https://jiruhub.js.org',
  };
  ...
  void toggleExtensionLogWindow(bool open) async {
    if (open && extensionLogWindowId.value == -1) {
      ...
      window
        ..center()
        ..setTitle("jiruhub extension debug")
        ..show();
  ...
  _getContributors() async {
    final res = await dio
        .get("https://api.github.com/repos/jephersonRD/JiruHub/contributors");
