...
import 'package:jiruhub/views/pages/detail_page.dart';
import 'package:jiruhub/views/pages/extension/extension_page.dart';
import 'package:jiruhub/views/pages/extension/extension_repo_page.dart';
import 'package:jiruhub/views/pages/extension/extension_settings_page.dart';
import 'package:jiruhub/views/pages/favorites_page.dart';
import 'package:jiruhub/views/pages/home_page.dart';
import 'package:jiruhub/views/pages/main_page.dart';
import 'package:jiruhub/views/pages/search/extension_searcher_page.dart';
import 'package:jiruhub/views/pages/search/search_page.dart';
import 'package:jiruhub/views/pages/settings/settings_page.dart';
import 'package:jiruhub/views/pages/tracking/anilist_more_page.dart';
