...
export default function BottomLeftCard() {
  ...
  return (
    <motion.div
      ...
      className="absolute bottom-28 right-4 left-auto md:left-6 md:right-auto md:bottom-6 lg:bottom-10 lg:left-10 p-3 md:p-4 lg:p-5 rounded-[1.2rem] md:rounded-[1.5rem] lg:rounded-[2.2rem] bg-white/30 backdrop-blur-xl flex flex-col gap-2 lg:gap-3 min-w-[180px] md:min-w-[200px] lg:min-w-[220px] w-fit"
    >
      <div className="flex items-center justify-between">
        <div className="flex flex-col">
          <span className="text-2xl md:text-3xl font-normal text-yellow-400 tracking-tight">
            {followers !== null ? formatFollowers(followers) : '—'}
          </span>
          <span className="text-[10px] md:text-[12px] font-normal text-yellow-400/80 tracking-wider">JephMD</span>
        </div>
      ...
      >
        ...
        <span className="text-[14px] font-normal text-[rgba(30,50,90,0.9)]">Sígueme en mi GitHub</span>
      </motion.a>
    </motion.div>
  );
}
