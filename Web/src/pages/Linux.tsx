...
const installCommand = 'curl -fsSL https://raw.githubusercontent.com/jephersonRD/JiruHub/main/jiru-install/install.sh | bash';
          ...
          <div className="flex-1 flex items-center justify-center px-6 w-full">
            ...
            >
              <div className="flex items-center gap-2 mb-4 justify-center">
                <svg fill="currentColor" stroke="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="w-5 h-5 text-[rgba(30,50,90,0.8)]">
                ...
                <span className="text-[rgba(30,50,90,0.9)] text-lg font-normal">Instalar en Linux</span>
              </div>
